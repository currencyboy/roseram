-- =====================================================
-- ROSERAM BUILDER - COMPLETE SCHEMA REBUILD
-- =====================================================
-- This script rebuilds the database with:
-- - All necessary tables for the application
-- - Proper FOREIGN KEY constraints (required by app logic)
-- - Unique constraints (for data integrity)
-- - Check constraints (for valid data values)
-- - Appropriate indexes for performance
-- - RLS policies for security
--
-- Based on actual code analysis of what the app needs
-- =====================================================
...
-- RLS Policy: Users can view chat messages from their projects
CREATE POLICY "Users can view chat messages from their projects" ON public.chat_messages
  FOR SELECT USING (
    auth.uid() = user_id OR
    EXISTS (
...
-- COMPLETION SUMMARY
-- =====================================================
-- ✓ Rebuilt all necessary tables
-- ✓ Added FOREIGN KEY constraints
-- ✓ Added UNIQUE constraints
-- ✓ Added CHECK constraints
-- ✓ Added GIN indexes for JSONB performance
-- ✓ Added RLS policies for security
-- ✓ Data is FULLY PRESERVED (if tables existed)
-- =====================================================
